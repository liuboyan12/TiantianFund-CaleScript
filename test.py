...
from PERSONAL_PACKAGING_MODES_AND_FUCTIONS.TianTianfundition_static_module import *
from BASE_CONDITIONING_MODES_AND_FUCTIONS.put_txt_in_dictionary import *
"""
